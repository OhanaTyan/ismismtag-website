...
xhr.onload = () => {
    if (xhr.status === 200) {
        ...
        document.getElementById("back_to_main_button").textContent = "返回首页"
        document.getElementById("back_to_main_button").addEventListener("click",function(){window.location.href="index.html"})
